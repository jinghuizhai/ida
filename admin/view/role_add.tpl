<div class="main-inner">
	<p class="p-title">添加角色</p>
	<div class="form-group">
		<p id="login-info"></p>
		<a href="#login-info" id="to-top"></a>
		<form action="<?php echo HOSTNAME;?>admin/role/add" method="post">
			<div class="p-group">
				<b>名称</b>
			...
			<div class="p-group">
				<b>TAG</b>
				<input id="tag" name="tag" value="<?php echo $tag;?>"/>
			</div>
			<div class="p-group">
				<b>登录入口</b>
			...
			<button class="btn" onclick="return checkRole(this);">添加</button>
		</form>
	</div>
</div>
<script type="text/javascript">
	...
	function exchangeEntrance(othis){
		...
		zjh.POST('<?php echo HOSTNAME;?>admin/role/jsonMethodList',{"entrance":value},function(r){
			if(r){
